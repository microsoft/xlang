...
namespace winrt
{
    [[nodiscard]] inline auto resume_background() noexcept
    {
        ...
        private:
            ...
            static void WINRT_IMPL_CALL callback(void*, void* context) noexcept
            {
    ...
    private:
        ...
        static int32_t WINRT_IMPL_CALL callback(impl::com_callback_args* args) noexcept
        {
    ...
    [[nodiscard]] inline auto resume_after(Windows::Foundation::TimeSpan duration) noexcept
    {
        ...
        private:
            ...
            static void WINRT_IMPL_CALL callback(void*, void* context, void*) noexcept
            {
                std::experimental::coroutine_handle<>::from_address(context)();
            }
    ...
    [[nodiscard]] inline auto resume_on_signal(void* handle, Windows::Foundation::TimeSpan timeout = {}) noexcept
    {
        ...
        private:
            ...
            static void WINRT_IMPL_CALL callback(void*, void* context, void*, uint32_t result) noexcept
            {
                auto that = static_cast<awaitable*>(context);
