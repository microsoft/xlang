...
namespace UnitTestApp
{
    ...
    public class UnitTest
    {
        ...
        const long COUNT = 1;
        const long MILLION = 1; //1000000;

        static void TestAppTestStrings(string test_string)
        {
            ...
            // todo: find a way to register components for activation in xunit tests,
            // to compare xlang projection with built-in C# support
#if true
        ...
        [TestMethod]
        public void TestAppTestShortString()
        {
         //   Assert.AreEqual(1, 0);
            TestAppTestStrings("x");
        }
