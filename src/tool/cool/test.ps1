...
& $coolrtexe -input local -output $outputDir -include Windows.Foundation -include Windows.Data.Json -include Windows.Foundation -exclude Windows.Foundation.Metadata