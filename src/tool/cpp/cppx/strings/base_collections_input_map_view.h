...
namespace xlang::impl
{
    ...
    struct input_map_view final :
        implements<input_map_view<K, V, Container>, non_agile, no_weak_ref, Runtime::IMapView<K, V>, Runtime::IIterable<Runtime::IKeyValuePair<K, V>>>,
    ...
    struct scoped_input_map_view final :
        input_scope,
        implements<scoped_input_map_view<K, V, Container>, non_agile, no_weak_ref, Runtime::IMapView<K, V>, Runtime::IIterable<Runtime::IKeyValuePair<K, V>>>,
    ...
    {
        using interface_type = Runtime::IMapView<K, V>;
