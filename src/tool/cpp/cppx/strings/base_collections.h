...
namespace xlang::impl
{
    ...
    struct key_value_pair<IKeyValuePair<K, V>> final : implements<key_value_pair<IKeyValuePair<K, V>>, IKeyValuePair<K, V>>
    {
    ...
    template <typename K, typename V>
    struct is_key_value_pair<IKeyValuePair<K, V>> : std::true_type {};
