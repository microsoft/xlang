...
namespace xlang::impl
{
    ...
    struct input_iterable final :
        implements<input_iterable<T, Container>, non_agile, no_weak_ref, IIterable<T>>,
    ...
    struct scoped_input_iterable final :
        input_scope,
        implements<scoped_input_iterable<T, InputIt>, non_agile, no_weak_ref, IIterable<T>>,
    ...
    {
        using interface_type = IIterable<T>;
...
WINRT_EXPORT namespace xlang::param
{
    ...
    {
        using value_type = T;
        using interface_type = IIterable<value_type>;
    ...
    struct iterable<IKeyValuePair<K, V>>
    {
        using value_type = IKeyValuePair<K, V>;
        using interface_type = IIterable<value_type>;
    ...
    template <typename K, typename V>
    struct async_iterable<IKeyValuePair<K, V>>
    {
        using value_type = IKeyValuePair<K, V>;
        using interface_type = IIterable<value_type>;
