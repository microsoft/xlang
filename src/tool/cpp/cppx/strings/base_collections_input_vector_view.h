...
namespace xlang::impl
{
    ...
    struct input_vector_view final :
        implements<input_vector_view<T, Container>, non_agile, no_weak_ref, System::IVectorView<T>, System::IIterable<T>>,
    ...
    struct scoped_input_vector_view final :
        input_scope,
        implements<scoped_input_vector_view<T, InputIt>, non_agile, no_weak_ref, System::IVectorView<T>, System::IIterable<T>>,
    ...
    {
        using interface_type = System::IVectorView<T>;
