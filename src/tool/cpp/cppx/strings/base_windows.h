...
WINRT_EXPORT namespace xlang
{
    ...
    template <typename T, typename = std::enable_if_t<!std::is_base_of_v<Runtime::IUnknown, T>>>
    ...
    template <typename T, typename V, typename = std::enable_if_t<!std::is_base_of_v<Runtime::IUnknown, T>>>
    ...
    template <typename T, typename = std::enable_if_t<!std::is_base_of_v<Runtime::IUnknown, std::decay_t<T>> && !std::is_convertible_v<T, std::wstring_view>>>
...
{
    template <typename T>
    using com_ref = std::conditional_t<std::is_base_of_v<Runtime::IUnknown, T>, T, com_ptr<T>>;
...
WINRT_EXPORT namespace xlang
{
    inline void* get_abi(Runtime::IUnknown const& object) noexcept
    {
        return *(void**)(&object);
    }

    inline void** put_abi(Runtime::IUnknown& object) noexcept
    {
        WINRT_ASSERT(get_abi(object) == nullptr);
        return reinterpret_cast<void**>(&object);
    }

    inline void attach_abi(Runtime::IUnknown& object, void* value) noexcept
    {
        object = nullptr;
        *put_abi(object) = value;
    }

    inline void* detach_abi(Runtime::IUnknown& object) noexcept
    {
    ...
    inline void copy_from_abi(Runtime::IUnknown& object, void* value) noexcept
    {
        object = nullptr;
    ...
    inline void copy_to_abi(Runtime::IUnknown const& object, void*& value) noexcept
    {
    ...
    inline ::IUnknown* get_unknown(Runtime::IUnknown const& object) noexcept
    {
