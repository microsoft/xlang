...
WINRT_EXPORT namespace xlang
{
    ...
    template <typename T, typename V, typename = std::enable_if_t<!std::is_base_of_v<IUnknown, T>>>
    ...
    template <typename T, typename = std::enable_if_t<!std::is_base_of_v<IUnknown, std::decay_t<T>> && !std::is_convertible_v<T, std::wstring_view>>>
...
WINRT_EXPORT namespace xlang
{
    ...
    inline void** put_abi(IUnknown& object) noexcept
    {
    ...
    inline void* detach_abi(IUnknown& object) noexcept
    {
    ...
    inline void copy_from_abi(IUnknown& object, void* value) noexcept
    {
        object = nullptr;
    ...
    inline void copy_to_abi(IUnknown const& object, void*& value) noexcept
    {
