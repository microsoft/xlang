...
{
    template <typename Interface = Runtime::IActivationFactory>
...
#pragma warning(pop)
    ...
    template <typename Class, typename Interface = Runtime::IActivationFactory, typename F>
    ...
    template <typename Class, typename Interface = Runtime::IActivationFactory>
