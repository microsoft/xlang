...
namespace xlang::xmeta
{
    ...
    struct method_model : base_model
    {
        ...
        method_model(std::string_view const& id, size_t decl_line, std::optional<type_ref>&& return_type, std::vector<formal_parameter_model>&& formal_params, std::string_view const& overridden_method_ref) :
            base_model{ id, decl_line },
            m_formal_parameters{ std::move(formal_params) },
            m_return_type{ std::move(return_type) },
