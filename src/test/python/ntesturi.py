...
class TestUri(unittest.TestCase):
    ...
    def test_activate_uri(self):
        u = wf.Uri.CreateUri("http://microsoft.com")
    ...
    def test_activate_uri2(self):
        u = wf.Uri.CreateWithRelativeUri("http://microsoft.com", "surface/studio")
        self.assertEqual(u.get_Domain(), "microsoft.com")
    ...
    def test_combine_uri(self):
        u1 = wf.Uri.CreateUri("http://microsoft.com")
    ...
    def test_activate_query_parsed(self):
        u = wf.Uri.CreateUri("http://microsoft.com?projection=python&platform=windows")
