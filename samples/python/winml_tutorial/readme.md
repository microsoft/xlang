...
module enables Python code to access a subset of the [Windows Runtime APIs](https://docs.microsoft.com/en-us/uwp/api/)
...
> Typically, Python extension modules are installed into Python's site-packages folder by
