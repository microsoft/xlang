...
{
    "_pyrt_Windows_Devices_Geolocation.CivicAddress",
...
{
    "_pyrt_Windows_Devices_Geolocation.GeoboundingBox",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geocircle",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geocoordinate",
...
{
    "_pyrt_Windows_Devices_Geolocation.GeocoordinateSatelliteData",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geolocator",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geopath",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geopoint",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geoposition",
...
{
    "_pyrt_Windows_Devices_Geolocation.Geovisit",
...
{
    "_pyrt_Windows_Devices_Geolocation.GeovisitMonitor",
...
{
    "_pyrt_Windows_Devices_Geolocation.GeovisitStateChangedEventArgs",
...
{
    "_pyrt_Windows_Devices_Geolocation.GeovisitTriggerDetails",
...
{
    "_pyrt_Windows_Devices_Geolocation.PositionChangedEventArgs",
...
{
    "_pyrt_Windows_Devices_Geolocation.StatusChangedEventArgs",
...
{
    "_pyrt_Windows_Devices_Geolocation.VenueData",
...
{
    "_pyrt_Windows_Devices_Geolocation.IGeoshape",
...
static void BasicGeoposition_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, BasicGeoposition_dealloc },
...
{
    "_pyrt_Windows_Devices_Geolocation.BasicGeoposition",
...
static int module_exec(PyObject* module)
{
    ...
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&CivicAddress_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "CivicAddress", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::CivicAddress>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&GeoboundingBox_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "GeoboundingBox", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::GeoboundingBox>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geocircle_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geocircle", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geocircle>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geocoordinate_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geocoordinate", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geocoordinate>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&GeocoordinateSatelliteData_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "GeocoordinateSatelliteData", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::GeocoordinateSatelliteData>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geolocator_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geolocator", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geolocator>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geopath_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geopath", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geopath>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geopoint_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geopoint", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geopoint>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geoposition_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geoposition", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geoposition>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Geovisit_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Geovisit", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::Geovisit>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&GeovisitMonitor_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "GeovisitMonitor", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::GeovisitMonitor>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&GeovisitStateChangedEventArgs_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "GeovisitStateChangedEventArgs", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::GeovisitStateChangedEventArgs>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&GeovisitTriggerDetails_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "GeovisitTriggerDetails", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::GeovisitTriggerDetails>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&PositionChangedEventArgs_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "PositionChangedEventArgs", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::PositionChangedEventArgs>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StatusChangedEventArgs_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StatusChangedEventArgs", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::StatusChangedEventArgs>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&VenueData_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "VenueData", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::VenueData>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IGeoshape_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IGeoshape", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::IGeoshape>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BasicGeoposition_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BasicGeoposition", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Devices::Geolocation::BasicGeoposition>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    return 0;
}
