...
static void Matrix3x2_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, Matrix3x2_dealloc },
...
{
    "_pyrt_Windows_Foundation_Numerics.Matrix3x2",
...
static void Matrix4x4_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, Matrix4x4_dealloc },
...
{
    "_pyrt_Windows_Foundation_Numerics.Matrix4x4",
...
static void Plane_dealloc(PyObject*)
{
}
...
{
    "_pyrt_Windows_Foundation_Numerics.Plane",
...
static void Quaternion_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, Quaternion_dealloc },
...
{
    "_pyrt_Windows_Foundation_Numerics.Quaternion",
...
static void Rational_dealloc(PyObject*)
{
}
...
{
    "_pyrt_Windows_Foundation_Numerics.Rational",
...
static void Vector2_dealloc(PyObject*)
{
}
...
{
    "_pyrt_Windows_Foundation_Numerics.Vector2",
...
static void Vector3_dealloc(PyObject*)
{
}
...
{
    "_pyrt_Windows_Foundation_Numerics.Vector3",
...
static void Vector4_dealloc(PyObject*)
{
}
...
{
    "_pyrt_Windows_Foundation_Numerics.Vector4",
...
static int module_exec(PyObject* module)
{
    ...
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Matrix3x2_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Matrix3x2", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::float3x2>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Matrix4x4_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Matrix4x4", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::float4x4>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Plane_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Plane", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::plane>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Quaternion_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Quaternion", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::quaternion>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Rational_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Rational", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::Rational>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Vector2_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Vector2", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::float2>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Vector3_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Vector3", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::float3>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&Vector4_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "Vector4", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Foundation::Numerics::float4>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    return 0;
}
