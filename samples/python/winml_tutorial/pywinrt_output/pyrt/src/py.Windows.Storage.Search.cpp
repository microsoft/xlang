...
{
    "_pyrt_Windows_Storage_Search.ContentIndexer",
...
{
    "_pyrt_Windows_Storage_Search.ContentIndexerQuery",
...
{
    "_pyrt_Windows_Storage_Search.IndexableContent",
...
{
    "_pyrt_Windows_Storage_Search.QueryOptions",
...
static PyObject* SortEntryVector_ReplaceAll(py::winrt_wrapper<winrt::Windows::Storage::Search::SortEntryVector>* self, PyObject* args)
{
    ...
    if (arg_count == 1)
    {
        try
        {
            ...
            auto param0 = winrt::array_view<const winrt::Windows::Storage::Search::SortEntry>(_param0.data(), _param0.data() + _param0.size());
...
{
    "_pyrt_Windows_Storage_Search.SortEntryVector",
...
{
    "_pyrt_Windows_Storage_Search.StorageFileQueryResult",
...
{
    "_pyrt_Windows_Storage_Search.StorageFolderQueryResult",
...
{
    "_pyrt_Windows_Storage_Search.StorageItemQueryResult",
...
{
    "_pyrt_Windows_Storage_Search.StorageLibraryChangeTrackerTriggerDetails",
...
{
    "_pyrt_Windows_Storage_Search.StorageLibraryContentChangedTriggerDetails",
...
{
    "_pyrt_Windows_Storage_Search.ValueAndLanguage",
...
{
    "_pyrt_Windows_Storage_Search.IIndexableContent",
...
{
    "_pyrt_Windows_Storage_Search.IStorageFolderQueryOperations",
...
{
    "_pyrt_Windows_Storage_Search.IStorageQueryResultBase",
...
static void SortEntry_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, SortEntry_dealloc },
...
{
    "_pyrt_Windows_Storage_Search.SortEntry",
...
static int module_exec(PyObject* module)
{
    ...
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&ContentIndexer_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "ContentIndexer", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::ContentIndexer>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&ContentIndexerQuery_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "ContentIndexerQuery", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::ContentIndexerQuery>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IndexableContent_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IndexableContent", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::IndexableContent>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&QueryOptions_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "QueryOptions", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::QueryOptions>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&SortEntryVector_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "SortEntryVector", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::SortEntryVector>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StorageFileQueryResult_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StorageFileQueryResult", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::StorageFileQueryResult>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StorageFolderQueryResult_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StorageFolderQueryResult", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::StorageFolderQueryResult>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StorageItemQueryResult_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StorageItemQueryResult", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::StorageItemQueryResult>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StorageLibraryChangeTrackerTriggerDetails_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StorageLibraryChangeTrackerTriggerDetails", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::StorageLibraryChangeTrackerTriggerDetails>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&StorageLibraryContentChangedTriggerDetails_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "StorageLibraryContentChangedTriggerDetails", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::StorageLibraryContentChangedTriggerDetails>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&ValueAndLanguage_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "ValueAndLanguage", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::ValueAndLanguage>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IIndexableContent_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IIndexableContent", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::IIndexableContent>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IStorageFolderQueryOperations_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IStorageFolderQueryOperations", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::IStorageFolderQueryOperations>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IStorageQueryResultBase_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IStorageQueryResultBase", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::IStorageQueryResultBase>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&SortEntry_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "SortEntry", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Storage::Search::SortEntry>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    return 0;
}
