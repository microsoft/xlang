...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapBuffer",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapCodecInformation",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapDecoder",
...
static PyObject* BitmapEncoder_SetPixelData(py::winrt_wrapper<winrt::Windows::Graphics::Imaging::BitmapEncoder>* self, PyObject* args)
{
    ...
    if (arg_count == 7)
    {
        try
        {
            ...
            auto param6 = winrt::array_view<const uint8_t>(_param6.data(), _param6.data() + _param6.size());
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapEncoder",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapFrame",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapProperties",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapPropertiesView",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapPropertySet",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapTransform",
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapTypedValue",
...
{
    "_pyrt_Windows_Graphics_Imaging.ImageStream",
...
{
    "_pyrt_Windows_Graphics_Imaging.PixelDataProvider",
...
{
    "_pyrt_Windows_Graphics_Imaging.SoftwareBitmap",
...
{
    "_pyrt_Windows_Graphics_Imaging.IBitmapFrame",
...
{
    "_pyrt_Windows_Graphics_Imaging.IBitmapFrameWithSoftwareBitmap",
...
{
    "_pyrt_Windows_Graphics_Imaging.IBitmapPropertiesView",
...
static void BitmapBounds_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, BitmapBounds_dealloc },
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapBounds",
...
static void BitmapPlaneDescription_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, BitmapPlaneDescription_dealloc },
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapPlaneDescription",
...
static void BitmapSize_dealloc(PyObject*)
{
}
...
{
    { Py_tp_dealloc, BitmapSize_dealloc },
...
{
    "_pyrt_Windows_Graphics_Imaging.BitmapSize",
...
static int module_exec(PyObject* module)
{
    ...
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapBuffer_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapBuffer", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapBuffer>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapCodecInformation_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapCodecInformation", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapCodecInformation>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapDecoder_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapDecoder", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapDecoder>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapEncoder_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapEncoder", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapEncoder>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapFrame_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapFrame", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapFrame>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapProperties_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapProperties", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapProperties>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapPropertiesView_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapPropertiesView", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapPropertiesView>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapPropertySet_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapPropertySet", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapPropertySet>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapTransform_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapTransform", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapTransform>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapTypedValue_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapTypedValue", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapTypedValue>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&ImageStream_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "ImageStream", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::ImageStream>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&PixelDataProvider_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "PixelDataProvider", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::PixelDataProvider>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&SoftwareBitmap_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "SoftwareBitmap", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::SoftwareBitmap>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IBitmapFrame_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IBitmapFrame", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::IBitmapFrame>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IBitmapFrameWithSoftwareBitmap_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IBitmapFrameWithSoftwareBitmap", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::IBitmapFrameWithSoftwareBitmap>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IBitmapPropertiesView_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IBitmapPropertiesView", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::IBitmapPropertiesView>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapBounds_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapBounds", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapBounds>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapPlaneDescription_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapPlaneDescription", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapPlaneDescription>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&BitmapSize_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "BitmapSize", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Graphics::Imaging::BitmapSize>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    return 0;
}
