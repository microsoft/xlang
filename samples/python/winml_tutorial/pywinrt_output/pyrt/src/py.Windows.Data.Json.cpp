...
{
    "_pyrt_Windows_Data_Json.JsonArray",
...
{
    "_pyrt_Windows_Data_Json.JsonError",
    0,
    0,
    Py_TPFLAGS_DEFAULT,
...
{
    "_pyrt_Windows_Data_Json.JsonObject",
...
{
    "_pyrt_Windows_Data_Json.JsonValue",
...
{
    "_pyrt_Windows_Data_Json.IJsonValue",
...
static int module_exec(PyObject* module)
{
    ...
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&JsonArray_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "JsonArray", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Data::Json::JsonArray>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpec(&JsonError_Type_spec) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "JsonError", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Data::Json::JsonError>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&JsonObject_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "JsonObject", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Data::Json::JsonObject>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&JsonValue_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "JsonValue", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Data::Json::JsonValue>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    {
        py::pyobj_handle type_object { PyType_FromSpecWithBases(&IJsonValue_Type_spec, bases.get()) };
        if (!type_object)
        {
            return -1;
        }
        if (PyModule_AddObject(module, "IJsonValue", type_object.get()) != 0)
        {
            return -1;
        }
        py::winrt_type<winrt::Windows::Data::Json::IJsonValue>::python_type = reinterpret_cast<PyTypeObject*>(type_object.detach());
    }
    return 0;
}
