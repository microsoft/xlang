...
static int module_exec(PyObject* module)
{
    ...
    type_object = PyType_FromSpecWithBases(&AppDataPaths_Type_spec, bases);
    ...
    type_object = PyType_FromSpecWithBases(&ApplicationData_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&ApplicationDataCompositeValue_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&ApplicationDataContainer_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&ApplicationDataContainerSettings_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SetVersionDeferral_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SetVersionRequest_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageFile_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageFolder_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageLibrary_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageLibraryChange_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageLibraryChangeReader_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageLibraryChangeTracker_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageProvider_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StorageStreamTransaction_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&StreamedFileDataRequest_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemAudioProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemDataPaths_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemGPSProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemImageProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemMediaProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemMusicProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemPhotoProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&SystemVideoProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&UserDataPaths_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageFile_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageFile2_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageFilePropertiesWithAvailability_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageFolder_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageFolder2_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageItem_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageItem2_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageItemProperties_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageItemProperties2_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStorageItemPropertiesWithProvider_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IStreamedFileDataRequest_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
