...
static int module_exec(PyObject* module)
{
    ...
    type_object = PyType_FromSpecWithBases(&Buffer_Type_spec, bases);
    ...
    type_object = PyType_FromSpecWithBases(&DataReader_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&DataReaderLoadOperation_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&DataWriter_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&DataWriterStoreOperation_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&FileInputStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&FileOutputStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&FileRandomAccessStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&InMemoryRandomAccessStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&InputStreamOverStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&OutputStreamOverStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&RandomAccessStreamOverStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&RandomAccessStreamReference_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IBuffer_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IContentTypeProvider_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IDataReader_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IDataWriter_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IInputStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IInputStreamReference_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IOutputStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IRandomAccessStream_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IRandomAccessStreamReference_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
    ...
    type_object = PyType_FromSpecWithBases(&IRandomAccessStreamWithContentType_Type_spec, bases);
    if (type_object == nullptr)
    {
        return -1;
    }
