...
#pragma warning(suppress: 4307)
    ...
    {
        constexpr static auto data{ combine("rc(", to_utf8<T>(), ";", signature<default_interface_t<T>>::data, ")") };
    };
...
namespace winrt::impl
{
    ...
    template <typename D, typename T> struct consume_IObservableVector
    {
        ...
        {
            check_hresult(WINRT_SHIM(wfc::IObservableVector<T>)->remove_VectorChanged(cookie));
        }
    ...
    template <typename D, typename K, typename V> struct consume_IObservableMap
    {
        ...
        {
            check_hresult(WINRT_SHIM(wfc::IObservableMap<K, V>)->remove_MapChanged(cookie));
        }
...
WINRT_EXPORT namespace winrt
{
    struct access_token : handle
    {
        ...
        static access_token client()
        {
            ...
            com_ptr<impl::IServerSecurity> server;
            check_hresult(WINRT_CoGetCallContext(guid_of<impl::IServerSecurity>(), server.put_void()));
...
namespace winrt::impl
{
    ...
    struct await_adapter
    {
        ...
        {
            com_ptr<impl::IContextCallback> context;
            check_hresult(WINRT_CoGetObjectContext(guid_of<impl::IContextCallback>(), context.put_void()));
...
WINRT_EXPORT namespace winrt
{
    ...
    struct apartment_context
    {
        apartment_context()
        {
            check_hresult(WINRT_CoGetObjectContext(guid_of<impl::IContextCallback>(), m_context.put_void()));
        }
