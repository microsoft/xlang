...
TEST_CASE("Mem alloc")
{
    ...
    {
        MemGuard ptr1{ XlangMemAlloc(0) };
        MemGuard ptr2{ XlangMemAlloc(0) };
    ...
    {
        MemGuard ptr1{ XlangMemAlloc(1) };
        MemGuard ptr2{ XlangMemAlloc(1) };
    ...
    SECTION("1 MB allocation")
    {
        ...
        MemGuard ptr{ XlangMemAlloc(size) };
    ...
    SECTION("Impossibly huge allocation")
    {
        ...
        MemGuard ptr{ XlangMemAlloc(std::numeric_limits<size_t>::max()) };
        REQUIRE(ptr.m_ptr == nullptr);
        // This will also check XlangMemFree with null
    }
}
